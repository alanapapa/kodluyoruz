...
<a href='#Task 4'>Task 4</a><br>
<a href='#Task 5'>Task 5</a><br>
<a href='#Task 6'>Task 6</a><br>
<a href='#Task 7'>Task 7</a><br>
<a href='#Task 8'>Task 8</a><br>
<a href='#Task 9'>Task 9</a><br>
<a href='#Task 10'>Task 10</a><br>
<a href='#Task 11'>Task 11</a><br>
<a href='#Task 12'>Task 12</a><br>
...
~~~sql
UPDATE Employee SET name = 'Shel' WHERE id = 1;
UPDATE Employee SET email = 'scrone1d@hud.gov' WHERE name = 'Shel';
UPDATE Employee SET birthday = '2021/05/29' WHERE email = 'scrone1d@hud.gov';
UPDATE Employee SET name = 'Shelly',birthday = '2021/02/11' WHERE id = 1;
UPDATE Employee SET birthday = '2021/05/29',name = 'Teena' WHERE email = 'tkitchingham1c@jigsy.com';
~~~
#### Sütunların her birine göre ilgili satırı silecek 5 adet DELETE işlemi yapalım.
~~~sql
DELETE FROM Employee WHERE name = 'Ebba';
DELETE FROM Employee WHERE email = 'vgallandre1b@t.co';
DELETE FROM Employee WHERE birthday = '2021/05/29';
DELETE FROM Employee WHERE name = 'Adelle';
DELETE FROM Employee WHERE id = '3';
~~~

---

## <p id = 'Task 9' > Task 9 </p>
...
GROUP BY customer.customer_id ORDER BY shop DESC;
~~~